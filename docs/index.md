...
- `oauth_client_credentials` (Attributes) Configuration for oauth client credential flow using the https://pkg.go.dev/golang.org/x/oauth2 implementation (see [below for nested schema](#nestedatt--oauth_client_credentials))
